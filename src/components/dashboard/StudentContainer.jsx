...
const StudentContainer = () => {
  const { ModalUI: CreateStudentModal, handleOpen: handleCreateStudent } = ModalContainer("CreateStudent");
    ...
    <>
      ...
      <Card className=' h-[300px] aspect-square FLEX-CENTER' isBlurred>
        {loading ? <Spinner color='success' size='lg' label='Loading...' /> : <CardBody className='flex flex-row justify-evenly items-center gap-4 p-4'>
          <Card className='w-full aspect-square FLEX-CENTER gap-8' isBlurred isPressable onPress={handleCreateStudent}>
            <PiStudent size={100} />
